...
namespace WebFileSystemCore.Tests
{
    ...
    public class WebFileSystemCoreTestModule : AbpModule
    {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(WebFileSystemCoreTestModule).GetAssembly());
        }
        ...
        private void SetupInMemoryDb()
        {
            ...
            IocManager.IocContainer.Register(
                Component
                    .For<DbContextOptions<WebFileSystemCoreDbContext>>()
